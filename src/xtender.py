...
class Xtender(ScomDevice):
    ...
    paramInfoTable = {
        ...
        'batteryVoltageToDeactivate': {'name': 'batteryVoltageToDeactivate', 'number': 1255,
                                       'propertyFormat': 'float', 'default': 0.0,
                                       'studerName': 'Battery voltage to deactivate (AUX 1)'},
        'remoteEntryActivate': {'name': 'remoteEntryActivate', 'number': 1545,
                                'propertyFormat': 'float', 'default': 0.0,
                                'studerName': 'Remote entry active'},

        'chargerAllowed': {'name': 'chargerAllowed', 'number': 1125,
                           'propertyFormat': 'float', 'default': 0.0,
                           'studerName': 'Charger allowed'},
    ...
    userInfoTable = {
        ...
        'stateOfTransferRelay': {'name': 'stateOfTransferRelay', 'number': 3020, 'propertyFormat': 'enum',
                            'default': 0, 'studerName': 'State of the transfer relay'},
    ...
    'battDischargeCurrentDay': {'name': 'battDischargeCurrentDay', 'number': 3078, 'propertyFormat': 'float', 'default': 0.0,
                           'studerName': 'Discharge of battery of the current day'},
    'energyACInCurrentDay': {'name': 'energyACInCurrentDay', 'number': 3081, 'propertyFormat': 'float', 'default': 0.0,
                           'studerName': 'Energy AC - In from the current day'},
    'consumersEnergyCurrentDay': {'name': 'consumersEnergyCurrentDay', 'number': 3083, 'propertyFormat': 'float', 'default': 0.0,
                           'studerName': 'Consumers energy of the current day'},
    ...
    'inputFrequency': {'name': 'inputFrequency', 'number': 3084, 'propertyFormat': 'float', 'default': 0.0,
        ...
        'operatingState': {'name': 'operatingState', 'number': 3028,
                           'propertyFormat': 'float', 'default': 0.0,
                           'studerName': 'Operating state'},

        'outputActivePowerMin': {'name': 'outputActivePowerMin', 'number': 3101,
                                 'propertyFormat': 'float', 'default': 0.0,
                                 'studerName': 'Output active power (minute avg)'},
        'inputActivePowerMin': {'name': 'inputActivePowerMin', 'number': 3119,
                                 'propertyFormat': 'float', 'default': 0.0,
                                 'studerName': 'Input active power (minute avg)'},
        }
    ...
    def get_value(self, address_number, format):
        ...
        return self._read_user_info_ex(value_format)
